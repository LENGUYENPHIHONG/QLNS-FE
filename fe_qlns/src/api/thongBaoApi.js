...
export const fetchUnreadNotifications = () => {
  return axios.get(`/api/ThongBao/unread`, {
...
export const markNotificationAsRead = (notificationId) => {
  return axios.put(
    `/api/ThongBao/${notificationId}/read`,
    null,
    { withCredentials: true }
  );
};
...
export const deleteNotification = (notificationId) => {
  return axios.delete(`/api/ThongBao/${notificationId}`, {
    withCredentials: true,
  });
};
...
export const deleteReadNotifications = () => {
  return axios.delete(`/api/ThongBao/read`, {
    withCredentials: true,
  });
};
