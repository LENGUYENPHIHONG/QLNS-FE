   ...
   return (
    <>
      <Layout style={{ minHeight: "100vh" }}>
        ...
        {authenticated  && <Sidebar collapsed={collapsed} onToggle={toggleSidebar} />}
        ...
        >
          ...
          >
            <Routes>
              ...
              <Route path="/kynangnhanvien" element={<EmployeeSkillsPage />} />
              ...
              <Route path="/danhsachdaotao" element={<EmployeeTrainingManagement />} />
              <Route path="/yeardetail" element={<LeaveYearDetail />} />
              ...
              <Route path="/loainhanvien" element={<EmployeeTypeManagement />} />
              <Route path="/loainghiphep" element={<LeaveTypeManagement />} />
              <Route path="/loaihopdong" element={<ContractTypeManagement />} />
              <Route path="/loaibaohiem" element={<InsuranceTypeManagement />} />
              <Route path="/loaichuyenmon" element={<SpecializationManagement />} />              <Route path="/loaikynang" element={<SkillsManagement />} />
              <Route path="/loaidaotao" element={<TrainingTypeManagement />} />
              {/* Mặc định redirect */}
